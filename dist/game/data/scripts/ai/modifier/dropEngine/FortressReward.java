...
public class FortressReward extends AbstractNpcAI
{
	...
	private static final int[] DGSERG_DROP1   = { Config.MIN_DROP_NORMAL, Config.MAX_DROP_NORMAL, Config.REWARD_CHANCE };
	private static final int[] DGSERG2        = { 35814, 36159, 35845, 36128, 36021, 35745, 36304, 35914, 35676 };
	private static final int[] DGSERG_DROP2   = { Config.MIN_DROP_CAP, Config.MAX_DROP_CAP, Config.REWARD_CHANCE };
	private static final int[] GENERAL        = { 36066, 36349, 35959, 35997, 36387, 35790, 36204, 36242, 36280, 35890, 35721 };
	private static final int[] GENERAL_DROP   = { Config.MIN_DROP_NORMAL, Config.MAX_DROP_NORMAL, Config.REWARD_CHANCE };
	...
	private static final int[] GUARD_DROP     = { Config.MIN_DROP_CAP, Config.MAX_DROP_CAP, Config.REWARD_CHANCE };
	...
	private static final int[] GUARDCAP_DROP  = { Config.MIN_DROP_NORMAL, Config.MAX_DROP_NORMAL, Config.REWARD_CHANCE };
	...
	private static final int[] HEALER_DROP    = { Config.MIN_DROP_CAP, Config.MAX_DROP_CAP, Config.REWARD_CHANCE };
	...
	private static final int[] REBELCOM_DROP  = { Config.MIN_DROP_NORMAL, Config.MAX_DROP_NORMAL, Config.REWARD_CHANCE };
	...
	private static final int[] REBELPRIV_DROP = { 4, 6, Config.REWARD_CHANCE };

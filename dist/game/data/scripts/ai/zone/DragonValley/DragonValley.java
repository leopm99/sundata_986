...
public final class DragonValley extends AbstractNpcAI
{
	...
	{
		CLASS_POINTS.put(ClassId.adventurer, 20);
		CLASS_POINTS.put(ClassId.arcanaLord, 22);
		CLASS_POINTS.put(ClassId.archmage, 21);
		CLASS_POINTS.put(ClassId.cardinal, 20);
		CLASS_POINTS.put(ClassId.dominator, 24);
		CLASS_POINTS.put(ClassId.doombringer, 23);
		...
		CLASS_POINTS.put(ClassId.evaSaint, 20);
		...
		CLASS_POINTS.put(ClassId.ghostSentinel, 20);
		CLASS_POINTS.put(ClassId.grandKhavatari, 20);
		CLASS_POINTS.put(ClassId.hellKnight, 22);
		CLASS_POINTS.put(ClassId.hierophant, 28);
		CLASS_POINTS.put(ClassId.judicator, 23);
		CLASS_POINTS.put(ClassId.moonlightSentinel, 20);
		CLASS_POINTS.put(ClassId.maestro, 29);
		CLASS_POINTS.put(ClassId.maleSoulhound, 31);
		CLASS_POINTS.put(ClassId.mysticMuse, 30);
		CLASS_POINTS.put(ClassId.phoenixKnight, 20);
		CLASS_POINTS.put(ClassId.sagittarius, 20);
		CLASS_POINTS.put(ClassId.shillienSaint, 20);
		CLASS_POINTS.put(ClassId.shillienTemplar, 30);
		CLASS_POINTS.put(ClassId.soultaker, 30);
		CLASS_POINTS.put(ClassId.spectralDancer, 20);
		CLASS_POINTS.put(ClassId.spectralMaster, 24);
		CLASS_POINTS.put(ClassId.stormScreamer, 30);
		CLASS_POINTS.put(ClassId.swordMuse, 20);
		CLASS_POINTS.put(ClassId.titan, 31);
		CLASS_POINTS.put(ClassId.trickster, 25);
		CLASS_POINTS.put(ClassId.windRider, 22);
	}
